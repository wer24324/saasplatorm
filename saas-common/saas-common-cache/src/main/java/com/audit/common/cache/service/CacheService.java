package com.audit.common.cache.service;
...
import com.audit.system.api.dict.feign.RemoteDictService;
import com.audit.tenant.api.source.feign.RemoteSourceService;
import com.audit.tenant.api.tenant.feign.RemoteStrategyService;
