...
public class ClassUtil extends cn.hutool.core.util.ClassUtil {
    ...
    public static boolean equals(Class<?> clazz1, Class<?> clazz2) {
        ...
        return ObjectUtil.equals(loader1, loader2)
                && ObjectUtil.equals(clazz1.getName(), clazz2.getName())
                && ObjectUtil.equals(clazz1.getPackage().getName(), clazz2.getPackage().getName());
    }
