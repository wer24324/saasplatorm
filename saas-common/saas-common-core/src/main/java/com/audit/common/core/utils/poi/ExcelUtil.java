package com.audit.common.core.utils.poi;
...
import com.audit.common.core.utils.file.FileTypeUtil;
import com.audit.common.core.utils.file.ImageUtil;
import com.audit.common.core.utils.core.*;
...
public class ExcelUtil<T> {
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet()) {
                    ...
                    if (String.class == fieldType) {
                        ...
                        if (val instanceof String) {
                            val = com.audit.common.core.utils.DateUtil.parseDate(val);
    ...
    public String parseDateToStr(String dateFormat, Object val) {
        ...
        if (val instanceof Date) {
            str = com.audit.common.core.utils.DateUtil.parseDateToStr(dateFormat, (Date) val);
        } else if (val instanceof LocalDateTime) {
            str = com.audit.common.core.utils.DateUtil.parseDateToStr(dateFormat, com.audit.common.core.utils.DateUtil.toDate((LocalDateTime) val));
        } else if (val instanceof LocalDate) {
            str = com.audit.common.core.utils.DateUtil.parseDateToStr(dateFormat, com.audit.common.core.utils.DateUtil.toDate((LocalDate) val));
        } else {
            str = val.toString();
        }
        return str;
