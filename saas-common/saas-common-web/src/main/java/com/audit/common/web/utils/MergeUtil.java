package com.audit.common.web.utils;
...
import com.audit.common.core.constant.basic.OperateConstants.SubOperate;
import com.audit.common.core.constant.basic.SqlConstants;
import com.audit.common.core.constant.error.UtilErrorConstants;
import com.audit.common.core.exception.UtilException;
import com.audit.common.core.utils.core.ArrayUtil;
import com.audit.common.core.utils.core.ClassUtil;
import com.audit.common.core.utils.core.CollUtil;
import com.audit.common.core.utils.core.ConvertUtil;
import com.audit.common.core.utils.core.NumberUtil;
import com.audit.common.core.utils.core.ObjectUtil;
import com.audit.common.core.utils.core.ReflectUtil;
import com.audit.common.core.utils.core.SpringUtil;
import com.audit.common.core.utils.core.StrUtil;
import com.audit.common.core.utils.core.TypeUtil;
...
import com.audit.common.web.entity.domain.SqlField;
...
public class MergeUtil {
    ...
    public static <D> D subMerge(D dto, SlaveRelation slaveRelation) {
        ...
        switch (slaveRelation.getRelationType()) {
            case DIRECT:
                assembleDirectObj(dto, slaveRelation);
                break;
            case INDIRECT:
                assembleIndirectObj(dto, slaveRelation);
                break;
        }
        return dto;
    }
    ...
    public static <D> List<D> subMerge(List<D> dtoList, SlaveRelation slaveRelation) {
        ...
        switch (slaveRelation.getRelationType()) {
            case DIRECT:
                assembleDirectList(dtoList, slaveRelation);
                break;
            case INDIRECT:
                assembleIndirectList(dtoList, slaveRelation);
                break;
        }
        return dtoList;
    }
    ...
    public static <D> int addMerge(D dto, SlaveRelation slaveRelation) {
        ...
        switch (slaveRelation.getRelationType()) {
            case DIRECT:
                return insertDirectObj(dto, slaveRelation);
            case INDIRECT:
    ...
    public static <D> int addMerge(Collection<D> dtoList, SlaveRelation slaveRelation) {
        ...
        switch (slaveRelation.getRelationType()) {
            case DIRECT:
                return insertDirectList(dtoList, slaveRelation);
            case INDIRECT:
    ...
    public static <D> int editMerge(D originDto, D newDto, SlaveRelation slaveRelation) {
        ...
        switch (slaveRelation.getRelationType()) {
            case DIRECT:
                return updateDirectObj(originDto, newDto, slaveRelation);
            case INDIRECT:
    ...
    public static <D> int editMerge(Collection<D> originList, Collection<D> newList, SlaveRelation slaveRelation) {
        ...
        switch (slaveRelation.getRelationType()) {
            case DIRECT:
                return updateDirectList(originList, newList, slaveRelation);
            case INDIRECT:
    ...
    public static <D> int delMerge(D dto, SlaveRelation slaveRelation) {
        ...
        switch (slaveRelation.getRelationType()) {
            case DIRECT:
                return deleteDirectObj(dto, slaveRelation);
            case INDIRECT:
    ...
    public static <D> int delMerge(Collection<D> dtoList, SlaveRelation slaveRelation) {
        ...
        switch (slaveRelation.getRelationType()) {
            case DIRECT:
                return deleteDirectList(dtoList, slaveRelation);
            case INDIRECT:
