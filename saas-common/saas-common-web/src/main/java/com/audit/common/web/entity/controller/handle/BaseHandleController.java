package com.audit.common.web.entity.controller.handle;
...
public abstract class BaseHandleController<Q extends BaseEntity, D extends BaseEntity, IDS extends IBaseService<Q, D>> extends BasisController {
     ...
     * @see com.audit.common.web.entity.controller.BaseController#batchRemove(List)
     * @see com.audit.common.web.entity.controller.BaseController#batchRemoveForce(List)
     */
