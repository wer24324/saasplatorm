package com.audit.common.datascope.interceptor;
...
@Aspect
@Component
public class SaasDataScopeHandler implements DataPermissionHandler {
    ...
    public Expression getSqlSegment(Expression where, String mappedStatementId) {
        ...
        com.audit.system.api.model.DataScope scope = SecurityUtils.getDataScope();
