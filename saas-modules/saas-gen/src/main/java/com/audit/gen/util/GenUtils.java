            ...
            if (ObjectUtil.isNotNull(optionField)) {
                switch (optionField) {
                    case ID:
                        ...
                        break;
                    case NAME:
                        optionJson.put(GenConstants.OptionField.TREE_NAME.getCode(),
                                column.getIdStr());
                        break;
                    case STATUS:
                        ...
                        break;
                    case SORT:
                        optionJson.put(GenConstants.OptionField.SORT.getCode(),
                                column.getIdStr());
                        break;
                    case PARENT_ID:
                        ...
                        break;
                    case ANCESTORS:
                        optionJson.put(GenConstants.OptionField.ANCESTORS.getCode(),
                                column.getIdStr());
                        break;
                    case LEVEL:
                        optionJson.put(GenConstants.OptionField.LEVEL.getCode(),
                                column.getIdStr());
                        break;
                }
            }
