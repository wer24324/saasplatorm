...
import com.audit.common.core.constant.gen.GenConstants;
import com.audit.common.core.constant.system.AuthorityConstants;
import com.audit.common.core.exception.ServiceException;
import com.audit.common.core.utils.core.*;
import com.audit.gen.config.GenConfig;
        ...
        switch (fromSource) {
            case CLOUD:
                if (template.contains("api.js.vm"))
                    return StrUtil.format("audit-ui/src/api/{}/{}/{}.js", moduleName, authorityName, businessName);
                else if (template.contains("auth.js.vm"))
                    return StrUtil.format("audit-ui/src/constants/auth/{}/{}/{}.auth.js", moduleName, authorityName, businessName);
                else if (template.contains("enum.js.vm"))
                    return StrUtil.format("audit-ui/src/constants/enums/{}/{}/{}.enum.js", moduleName, authorityName, businessName);

                else if (template.contains("index.vue.vm"))
                    return StrUtil.format("audit-ui/src/views/{}/{}/{}/index.vue", moduleName, authorityName, businessName);
                break;
            case MULTI:
