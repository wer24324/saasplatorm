...
import com.audit.system.api.organize.feign.RemotePostService;
...
import com.audit.tenant.tenant.domain.model.TeTenantRegister;
import com.audit.tenant.tenant.manager.impl.TeTenantManagerImpl;
import com.audit.tenant.tenant.service.ITeStrategyService;
import com.audit.tenant.tenant.service.ITeTenantService;
...
import static com.audit.common.core.constant.basic.BaseConstants.TOP_ID;
